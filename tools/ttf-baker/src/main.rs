...
fn main() {
    ...
    let imga = vxresult!(i32::from_str(argmatches.value_of("aspect").unwrap_or("1024")));
    ...
    vxlogi!("Line base gap: {}, Interleaved space: {}", line_base_gap, interleaved_space);
    ...
    let imghinc = (paddingf + paddingf + charh.ceil()) as i32;
            ...
            glyph.draw(|x, y, v| {
                image.put_pixel(
                    ...
                    Rgba {
                        ...
                        // data: [colour.0, colour.1, colour.2, 255u8],
                    },
                )
            });
            incx += paddingi as i32;
