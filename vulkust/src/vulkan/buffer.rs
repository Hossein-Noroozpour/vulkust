...
impl RootBuffer {
    pub fn new(size: isize, location: Location) -> Self {
...
pub struct UploaderBuffer {}

pub struct DynamicBuffer {}

pub struct Manager {
    pub static_buffer: Arc<RwLock<StaticBuffer>>,
    pub uploader_buffer: Arc<RwLock<UploaderBuffer>>,
    pub dynamic_buffers: Vec<Arc<RwLock<DynamicBuffer>>>,
}
...
impl Manager {
    pub fn new(
        logical_device: Arc<LogicalDevice>,
        static_size: usize,
        static_uploader_size: usize,
        dynamics_size: usize, 
        frames_count: usize) -> Self {
        let total_size = static_size + (dynamics_size * frames_count);
        let static_buffer;
