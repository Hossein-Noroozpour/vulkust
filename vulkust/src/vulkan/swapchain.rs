...
impl Swapchain {
    pub fn new(logical_device: Arc<LogicalDevice>, surface: Arc<Surface>) -> Self {
        let surface_caps = logical_device.physical_device.get_surface_capabilities(surface.clone());
