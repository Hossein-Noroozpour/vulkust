...
impl<CoreApp> OsApplicationTrait<CoreApp> for Application<CoreApp>
    ...
    fn new(args: *const c_void) -> Self {
        ...
        unsafe {
            xcb::xcb_create_window(
                this.connection, xcb::XCB_COPY_FROM_PARENT as u8, this.window, (*this.screen).root,
                0, 0, default_window_width!(), default_window_height!(), 0,
        ...
        this.atom_wm_delete_window = unsafe {
        ...
        unsafe {
            xcb::xcb_change_property(
                ...
                xcb::xcb_atom_enum_t::XCB_ATOM_STRING as u32, 8,
    ...
    fn execute(&mut self) -> bool {
        ...
        while self.is_running {
            ...
            logi!("Reached");
            let tmp: usize = unsafe { transmute(self.render_engine) };
            logi!("You must go {}", tmp);
        ...
        unsafe {
            if (xproto::XCB_DESTROY_NOTIFY as u8 == ((*e).response_type & 0x7f)) ||
                ((xproto::XCB_CLIENT_MESSAGE as u8 == ((*e).response_type & 0x7f)) &&
                    ((*transmute::<*mut xcb::xcb_generic_event_t,
                        *mut xcb::xcb_client_message_event_t>(e)).data._bindgen_data_[0] ==
