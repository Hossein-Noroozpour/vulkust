...
// dispatch_fd_t
pub type dispatch_data_t = *mut Object;
...
extern {
    ...
    pub fn dispatch_data_create(
        buffer: *const c_void, size: size_t, queue: dispatch_queue_t,
...
pub const DISPATCH_DATA_DESTRUCTOR_DEFAULT:dispatch_block_t = 0 as dispatch_block_t;
